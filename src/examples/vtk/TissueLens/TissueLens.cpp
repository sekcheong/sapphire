...
#if defined(_WIN32)
    std::string fname("C:/devel/nebula/data/vtk/Testing/Data/FullHead.mhd");
#elif defined(__APPLE__)
  std::string fname("/Users/scheong/devel/nebula-build/data/vtk/Testing/Data/FullHead.mhd");
#elif defined(__unix__)
    std::string fname("/home/scheong/devel/nebula-build/data/vtk/Testing/Data/FullHead.mhd");
#endif
